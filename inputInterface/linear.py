...
#
# Created: Sat Mar 14 00:04:04 2015
...
class Ui_Form(QtGui.QWidget):
    ...
    def setupUi(self):
        ...
        self.widget.setGeometry(QtCore.QRect(20, 20, 311, 101))
    ...
    def retranslateUi(self):
        ...
        self.pushButton_5.setText(_translate("Form", "ax+by < 0", None))
        self.pushButton_4.setText(_translate("Form", "ax+by <= 0", None))
        self.pushButton_2.setText(_translate("Form", "ax+by=0", None))
        self.pushButton_8.setText(_translate("Form", "CLEAR", None))
        self.pushButton_3.setText(_translate("Form", "ax+by >= 0", None))
        self.pushButton_7.setText(_translate("Form", "ENTER", None))
        self.pushButton.setText(_translate("Form", "y=mx+c", None))
        self.pushButton_6.setText(_translate("Form", "ax+by > 0", None))

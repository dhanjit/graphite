...
struct qt_meta_stringdata_QPyDeclarativePropertyValueSource_t {
    QByteArrayData data[1];
    char stringdata[34];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QPyDeclarativePropertyValueSource_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QPyDeclarativePropertyValueSource_t qt_meta_stringdata_QPyDeclarativePropertyValueSource = {
    {
QT_MOC_LITERAL(0, 0, 33) // "QPyDeclarativePropertyValueSo..."
...
const QMetaObject QPyDeclarativePropertyValueSource::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QPyDeclarativePropertyValueSource.data,
      qt_meta_data_QPyDeclarativePropertyValueSource,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QPyDeclarativePropertyValueSource::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QPyDeclarativePropertyValueSource.stringdata))
    ...
    if (!strcmp(_clname, "org.qt-project.Qt.QDeclarativePropertyValueSource"))
        return static_cast< QDeclarativePropertyValueSource*>(const_cast< QPyDeclarativePropertyValueSource*>(this));

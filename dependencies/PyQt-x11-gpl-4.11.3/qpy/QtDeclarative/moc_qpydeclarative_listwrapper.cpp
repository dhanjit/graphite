...
struct qt_meta_stringdata_ListWrapper_t {
    QByteArrayData data[1];
    char stringdata[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ListWrapper_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ListWrapper_t qt_meta_stringdata_ListWrapper = {
    {
QT_MOC_LITERAL(0, 0, 11) // "ListWrapper"
...
const QMetaObject ListWrapper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ListWrapper.data,
      qt_meta_data_ListWrapper,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ListWrapper::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ListWrapper.stringdata))
